class GeneralSettingsController < ApplicationController
  ...
  private
    ...
    def general_setting_params
      params.require(:general_setting).permit(:prompt_id, :negative_prompt_id, :sampling_setting_id, :checkpoint_id, :lora_id, :lycoris_id, :category_id, :tag_id, :discription)
    end
end
